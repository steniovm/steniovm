...
function sendregister(){
    ...
    if (indexplayer >= 0){
        players[indexplayer].description = gamedates.getUser().description
        players[indexplayer].score = gamedates.getUser().score
        players[indexplayer].level = gamedates.getUser().level
        players[indexplayer].timecred = gamedates.getUser().timecred
    }else{
        let newplayer = gamedates.getUser()
...
function sendstatus(name){
    ...
    let data = players[indexplayer]
    if (indexplayer >= 0){
        gamedates.setnameuser(data);
